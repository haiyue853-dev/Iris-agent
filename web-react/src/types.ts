...
export type AgentEvent =
  | { type: 'react_step'; data: { phase: 'thought' | 'action' | 'observation' | 'final'; content?: string; call_id?: string; name?: string; arguments?: Record<string, unknown>; ok?: boolean; result?: unknown; error_code?: string; error_message?: string; round?: number; attempt?: number; retry?: boolean } }
